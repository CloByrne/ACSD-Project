  ...
  return (
    <div>
      ...
      <div className="home-body">
        ...
        <p className="home-paragraph">Use the <Link to="/Recipes" style={{color: "#B99855"}}>Recipes</Link> tab to search for recipes based on the ingredients you have in your kitchen</p>
